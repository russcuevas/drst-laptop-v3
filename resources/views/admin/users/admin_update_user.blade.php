        ...
        <div class="container-fluid">
            <div class="block-header">
                <ol class="breadcrumb breadcrumb-col-red">
                    ...
                    <li class="active"><i class="material-icons">groups</i> User Management</li>
                    <li class="active"><i class="material-icons">groups</i> Add users</li>
                </ol>
            </div>
            <!-- Advanced Validation -->
                ...
                <div class="col-lg-8 col-md-8 col-sm-12col-xs-12 col-centered">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <br>
                            <br>
                            <form id="form_advanced_validation" action="{{ route('admin.updateusersrequest', $user->id)}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="number" class="form-control" name="contact" value="{{ old('contact', $user->contact) }}" minlength="11" maxlength="11" required>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="password" class="form-control" name="confirm_password" maxlength="20" minlength="6" required>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <select name="role" class="form-control show-tick">
                                            ...
                                            <option value="staff" {{ $old_role == 'staff' ? 'selected' : '' }}>Staff</option>
                                            <option value="customers" {{ $old_role == 'customers' ? 'selected' : '' }}>Customers</option>
                                        </select>
                                    </div>
                                </div>
