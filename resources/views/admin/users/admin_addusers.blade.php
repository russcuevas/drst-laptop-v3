                ...
                <div class="col-lg-8 col-md-8 col-sm-12col-xs-12 col-centered">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <br>
                            <br>
                            <form id="form_advanced_validation" action="{{ route('admin.addusersrequest')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="number" class="form-control" name="contact" value="{{ old('contact') }}" minlength="11" maxlength="11" required>
                                ...
                                <div style="display: flex !important; justify-content: end !important; align-items: flex-end !important">
                                    <input class="btn bg-custom btn-lg" type="submit" name="submit" value="Add users">
                                </div>
                            </form>
                        </div>
                    </div>
