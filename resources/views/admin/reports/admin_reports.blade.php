...
<section class="content">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            @if (count($reports) > 0)
                                <a href="{{ route('admin.generateReports', ['type' => 'pdf']) }}" style="color: #fff" class="btn btn bg-custom waves-effect btn-lg" style="margin-bottom: 15px;">Generate PDF Report</a>
                            @endif                            
                        </div>
                            {{-- display results --}}
                            @if(session('error'))
    ...
    <script src="{{ asset('admin/js/reports_management.js')}}"></script>
    <!-- Demo Js -->
