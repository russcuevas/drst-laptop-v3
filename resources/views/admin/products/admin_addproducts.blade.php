        ...
        <div class="container-fluid">
            <div class="block-header">
                <ol class="breadcrumb breadcrumb-col-red">
                    ...
                    <li class="active"><i class="material-icons">inventory</i> Add Products</li>
                </ol>
            </div>
            <!-- Advanced Validation -->
                ...
                <div class="col-lg-8 col-md-8 col-sm-12col-xs-12 col-centered">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <br>
                            <br>
                            <form id="form_advanced_validation" action="{{ route('admin.addproductsrequest')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input id="productImageInput" type="file" autocomplete="off" class="form-control" name="product_picture" onchange="previewImage(this)" required>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input id="" type="text" autocomplete="off" class="form-control" value="{{ old('product_price')}}" name="product_price" maxlength="11" required>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input id="" type="text" autocomplete="off" class="form-control" value="{{ old('product_type')}}" name="product_type" required>
                                ...
                                <div style="display: flex !important; justify-content: end !important; align-items: flex-end !important">
                                    <input class="btn bg-custom btn-lg" type="submit" name="submit" value="Add products">
                                </div>
                            </form>
                        </div>
                    </div>
