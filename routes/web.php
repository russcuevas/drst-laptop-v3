...
////////////////////////// PUBLIC PAGE /////////////////////////////////
// PUBLIC PAGE
Route::middleware([CacheControlMiddleware::class])->group(function () {
...
Route::middleware([CacheControlMiddleware::class])->group(
    function () {
        ////////////////////////// ADMIN /////////////////////////////////
        // ADMIN DASHBOARD
...
Route::middleware([CacheControlMiddleware::class])->group(
    function () {
        ...
        Route::get('/staff-comparison-sales', [StaffAnalyticsController::class, 'GetComparisonSales'])->name('staff-comparison.sales');
        ////////////////////////// -END- /////////////////////////////////
    }
);
