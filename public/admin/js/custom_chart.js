...
function updateComparisonChart() {
    ...
    fetch(`/comparison-sales?yearSales=${selectedYearSales}&yearComparison=${selectedYearComparison}`)
...
function updateChart() {
    ...
    xhr.open('GET', '/weekly-sales?year=' + selectedYear + '&month=' + selectedMonth, true);
...
function updateBarChart() {
    var xhr = new XMLHttpRequest();
    xhr.open('GET', '/monthly-sales?year=' + selectedYearMonthly, true);
...
function updateYearlyChart() {
    var xhr = new XMLHttpRequest();
    xhr.open('GET', '/yearly-sales', true);
